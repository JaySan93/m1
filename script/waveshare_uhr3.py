...
def main():
        ...
        draw.text((138, 36), bitrate, font = fontXS, fill = 0)
        draw.text((138, 22), streamingservice, font = fontXS, fill = 0)
        draw.text((188, 50), volume, font = fontXS, fill = 0)
        ...
        draw.text((138, 50), 'VOLUME',font = fontXS, fill = 0)
