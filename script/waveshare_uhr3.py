...
def main():
        ...
        draw.rectangle((0, 48, 212, 41), fill = 0) #rectangle behind track ID
        ...
        draw.text((0, 26), trackIDString, font = fontS, fill = 1)       # volumio track ID
