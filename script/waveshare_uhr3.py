...
def main():
        ...
        draw.text((135, 42), bitrate, font = fontXS, fill = 0)
        draw.text((135, 18), streamingservice, font = fontXS, fill = 0)
        draw.text((185, 56), volume, font = fontXS, fill = 0)
        ...
        draw.text((135, 0), 'CPU TEMP',font = fontXS, fill = 0)
        draw.text((135, 48), 'VOLUME',font = fontXS, fill = 0)
